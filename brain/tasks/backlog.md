...
## Backlog
- Define the first canonical design tokens and shared primitive set in `packages/ui`
- Define initial tenant onboarding flow
- Define first website template and section library
- Define initial billing model for subscriptions and AI credits
- Choose initial domain provider
- Generate the first Drizzle migration for users, companies, and memberships
