...
- A dedicated Sandbox app provides isolated template authoring and public
  read-only share previews without creating tenant or production website data.
...
- Template sandbox profile authoring and preview rendering
