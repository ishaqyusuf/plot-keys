...
- Add `app/[...slug]/page.tsx` as a catch-all route that redirects to `/` unless the repository has an explicit reason to diverge. Plot Keys tenant-site public pages intentionally use explicit App Router page routes per ADR-012.
