...
- The standalone `apps/sandbox` app owns template sandbox authoring and public
  share previews; `packages/website-builder` owns reusable Builder/Sandbox
  preview presentation behavior.
