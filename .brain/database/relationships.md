...
- The classification belongs to `Company`, covering its memberships, assets,
  domains, billing rows, and operational aggregate.
- `QaPurgeRun` has no company relation so the counts-only receipt survives.
