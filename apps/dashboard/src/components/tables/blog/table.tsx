...
import { columns, type BlogPostTableRow } from "./columns";
import { DataTableHeader } from "./data-table-header";
import { BlogTableHeader } from "./table-header";
...
export function BlogDataTable({
  ...
  const tableScroll = useTableScroll({
    startFromColumn: STICKY_COLUMNS.blog.length,
    useColumnWidths: true,
  });
  const rows = table.getRowModel().rows;
  const rowHeight = ROW_HEIGHTS.blog;
  ...
  return (
    <>
      <BlogTableHeader postCount={postCount} />
