...
import { NotificationsTableHeader } from "./table-header";
...
export function NotificationsDataTable({
  ...
  const { setColumns } = useNotificationsStore();
  ...
  const tableScroll = useTableScroll({
    startFromColumn: STICKY_COLUMNS.notifications.length,
    useColumnWidths: true,
  });
  const rows = table.getRowModel().rows;
  const rowHeight = ROW_HEIGHTS.notifications;
  ...
  return (
    <>
      <NotificationsTableHeader notificationCount={notificationCount} />
