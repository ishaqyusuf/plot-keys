...
import { LeadsTableHeader } from "./table-header";
...
export function LeadsDataTable({
  ...
  const { setColumns } = useLeadsStore();
  ...
  const tableScroll = useTableScroll({
    startFromColumn: STICKY_COLUMNS.leads.length,
    useColumnWidths: true,
  });
  const rows = table.getRowModel().rows;
  const rowHeight = ROW_HEIGHTS.leads;
  ...
  return (
    <>
      <LeadsTableHeader leadCount={leadCount} />
