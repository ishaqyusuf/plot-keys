...
import { TeamMembersTableHeader } from "./table-header";
...
export function TeamMembersTable({
  ...
  const { setColumns } = useTeamMembersStore();
  ...
  const tableScroll = useTableScroll({
    startFromColumn: STICKY_COLUMNS.team.length,
    useColumnWidths: true,
  });
  const rows = table.getRowModel().rows;
  const rowHeight = ROW_HEIGHTS.team;
  ...
  return (
    <>
      <TeamMembersTableHeader memberCount={memberCount} />
