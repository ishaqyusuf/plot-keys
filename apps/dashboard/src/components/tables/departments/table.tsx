...
import { DepartmentsTableHeader } from "./table-header";
...
export function DepartmentsDataTable({
  ...
  const { setColumns } = useDepartmentsStore();
  ...
  const tableScroll = useTableScroll({
    startFromColumn: STICKY_COLUMNS.departments.length,
    useColumnWidths: true,
  });
  const rows = table.getRowModel().rows;
  const rowHeight = ROW_HEIGHTS.departments;
  ...
  return (
    <>
      <DepartmentsTableHeader departmentCount={departmentCount} />
