...
export const APP_REGISTRY: AppDefinition[] = [
  ...
  },
  {
    ...
    name: "Listings",
    description:
      "Manage home and land listings, agents, and your blog/CMS content.",
    icon: Icon.Building,
    isCore: false,
    defaultInstalled: true,
    navGroup: {
      label: "Listings",
      items: [
        { href: "/properties", icon: Icon.Building, label: "Listings" },
        { href: "/estates", icon: Icon.Building, label: "Estate launches" },
